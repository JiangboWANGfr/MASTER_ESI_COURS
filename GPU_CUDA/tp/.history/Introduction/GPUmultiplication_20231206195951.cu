 ...
 *       3. the result is stored in matC at the appropriate row-column index.
 *  Each thread calculates one element of the resulting matrix matC. The index row * cols + col identifies the position in matC where the result of this dot product is stored.
 * 
 * 
 * 
