...
add_force {/IP_PWM/writedata_avalon} -radix bin {00000002 0ns}
run 10 ns
add_force {/IP_PWM/address_avalon} -radix bin {00 0ns}
add_force {/IP_PWM/writedata_avalon} -radix bin {00000064 0ns}
run 10 ns
add_force {/IP_PWM/address_avalon} -radix bin {01 0ns}
add_force {/IP_PWM/writedata_avalon} -radix bin {0000007F 0ns}
run 10 ns