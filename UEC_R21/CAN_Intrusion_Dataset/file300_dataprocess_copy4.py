    ...
    for input_file in input_file_list:
        with open(input_file, 'r') as file:
            ...
            # for line_index in range(len(lines)):
                ...
                if "100" in line.split()[4]:
                    total_id_count -= 1
                    line_id = line.split()[3]
                    for i in range(0, 6):
                        total_id_count += 1
                        parts = lines[line_index+i].split()
                        if line_id in parts[3]:
                            total_id_count -= 1
                            break
                    line_index += i+1
        ...
        payload_length_counts.append(payload_length_count/total_id_count)
