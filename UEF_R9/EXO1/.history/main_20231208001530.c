...
*/
Exercice 9:
Donnez I'affichage obtenu suite a l'execution sous UcoslI du programme suivant.
tinc1ude"1 neludes,h”/人Toute31es1 nclusions n0c03sa1r0四
Fdetine TASK STK SIZE 1024
OS_STK Tasklstk[TASK_STK SIZE]
OS_STK Task25tk[TASK_S7K_SI2E1:
03EET·stm_t1,"s0m2:
void Taskl (void 'pdata):
void Task2 void pdata):
int main(void)
OSInst:
sen_t1 OSSencreate[0):
w◆mt2-0S5 encreate1:
OSTaakCreate(Task1,(void 0.GTasklsEk[TASK_STK_SIZE],11):
OSTaskCreate(Task2,(void .0,&Taak2Stk[TASK_STX_SIZE].12):
osstart ()
printf("Fin du programme\n")/
return 0:
void Taskl(void 'pdatal
INTBU GEE:
INTOU 1
printf("TIA,"):
h110(1)
printf("T1B.")
OSSemPend(sen_t1,0,serr):
pr4ntf1“T1C1=d,",1}:
1t4>0
OSSemPost (aom t2)
1--7
