...
* File : PC.C
* By   : Jean J. Labrosse
* By   : Miro Samek,  adopted for Turbo C++ 1.01
*********************************************************************************************************
*/
...
void PC_DispClrScr (INT8U color)
{
    ...
    pscr = (INT8U far *)MK_FP(DISP_BASE, (INT16U)0x0000);
...
void *PC_VectGet (INT8U vect)
{
    ...
    pvect = (INT16U *)MK_FP(0x0000, (INT16U)(vect * 4)); /* Point into IVT at desired vector location  */
    OS_ENTER_CRITICAL();
