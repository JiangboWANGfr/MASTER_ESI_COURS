...
*  @details 1. for each element in the result matrix, compute the sum of the products of the corresponding row of the first matrix and the corresponding column of the second matrix.
