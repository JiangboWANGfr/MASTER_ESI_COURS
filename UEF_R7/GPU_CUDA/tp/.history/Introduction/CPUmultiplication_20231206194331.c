...
* @example to compute the element at row 1, column 1 of the result matrix, multiply every element in the first
           row of the first matrix by every element in the first column of the second matrix, and then take the
           sum of all those products. This will give you the value for the element at row 1, column 1 of the result matrix.
