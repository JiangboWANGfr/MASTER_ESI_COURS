 ...
 *         2. we calculate the index of the element of matC computed by the thread
 *            the for loop is used to compute the sum of the products of the elements of matA and matB
 * 
